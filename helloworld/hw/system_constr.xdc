...
set_property  -dict {PACKAGE_PIN  K13  IOSTANDARD LVCMOS18 } [get_ports Test_Gpio[0]]
set_property  -dict {PACKAGE_PIN  M12  IOSTANDARD LVCMOS18 } [get_ports Test_Gpio[1]]
set_property  -dict {PACKAGE_PIN  R10  IOSTANDARD LVCMOS18 } [get_ports Test_Gpio[2]]
