...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net sys_ps7_axi_periph_M00_AXI [get_bd_intf_pins axi_gpio_0/S_AXI] [get_bd_intf_pins sys_ps7_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net In0_1 [get_bd_ports In0] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net rst_sys_ps7_100M_interconnect_aresetn [get_bd_pins rst_sys_ps7_100M/interconnect_aresetn] [get_bd_pins sys_ps7_axi_periph/ARESETN]
  connect_bd_net -net rst_sys_ps7_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins rst_sys_ps7_100M/peripheral_aresetn] [get_bd_pins sys_ps7_axi_periph/M00_ARESETN] [get_bd_pins sys_ps7_axi_periph/M01_ARESETN] [get_bd_pins sys_ps7_axi_periph/S00_ARESETN]
  connect_bd_net -net sys_ps7_FCLK_CLK0 [get_bd_ports FCLK_CLK0] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins rst_sys_ps7_100M/slowest_sync_clk] [get_bd_pins sys_ps7/FCLK_CLK0] [get_bd_pins sys_ps7/M_AXI_GP0_ACLK] [get_bd_pins sys_ps7_axi_periph/ACLK] [get_bd_pins sys_ps7_axi_periph/M00_ACLK] [get_bd_pins sys_ps7_axi_periph/M01_ACLK] [get_bd_pins sys_ps7_axi_periph/S00_ACLK]
  connect_bd_net -net sys_ps7_FCLK_CLK1 [get_bd_ports FCLK_CLK1] [get_bd_pins sys_ps7/FCLK_CLK1]
  connect_bd_net -net sys_ps7_FCLK_RESET0_N [get_bd_ports FCLK_RESET0_N] [get_bd_pins rst_sys_ps7_100M/ext_reset_in] [get_bd_pins sys_ps7/FCLK_RESET0_N]
  connect_bd_net -net sys_ps7_FCLK_RESET1_N [get_bd_ports FCLK_RESET1_N] [get_bd_pins sys_ps7/FCLK_RESET1_N]
